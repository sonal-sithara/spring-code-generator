...
exports.groupByCategory = exports.COMMAND_CATALOG = exports.CATEGORY_ORDER = void 0;
...
const groupByCategory = () => {
    const map = new Map();
    for (const cat of exports.CATEGORY_ORDER) {
        map.set(cat, []);
    }
    for (const entry of exports.COMMAND_CATALOG) {
