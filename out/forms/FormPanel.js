...
const showForm = async (schema) => {
    return new Promise((resolve) => {
        const panel = vscode.window.createWebviewPanel("springCodeGeneratorForm", schema.title, vscode.ViewColumn.One, {
            enableScripts: true,
...
const escapeHtml = (s) => s
    ...
    .replace(/"/g, "&quot;")
    .replace(/'/g, "&#39;");
const renderHtml = (webview, schema) => {
